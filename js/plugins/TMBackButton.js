 ...
 * @default 0
 *
 * @param sceneQuestBookX
 * @desc Scene_QuestBookの戻るボタンＸ座標。
 * 初期値: 0
 * @default 0
 *
 * @param sceneQuestBookY
 * @desc Scene_QuestBookの戻るボタンＹ座標。
 * 初期値: 0
 * @default 0
 *
 * @param scenePartyX
 * @desc Scene_Partyの戻るボタンＸ座標。
 * 初期値: 0
 * @default 0
 *
 * @param scenePartyY
 * @desc Scene_Partyの戻るボタンＹ座標。
 * 初期値: 0
 * @default 0
 *
 * @help
...
TMPlugin.BackButton.SceneQuestBookX = +(TMPlugin.BackButton.Parameters['sceneQuestBookX'] || 0);
TMPlugin.BackButton.SceneQuestBookY = +(TMPlugin.BackButton.Parameters['sceneQuestBookY'] || 0);
TMPlugin.BackButton.ScenePartyX = +(TMPlugin.BackButton.Parameters['scenePartyX'] || 0);
TMPlugin.BackButton.ScenePartyY = +(TMPlugin.BackButton.Parameters['scenePartyY'] || 0);
...
(function() {
  ...
  Scene_QuestBook.prototype.backButtonX = function() {
    return TMPlugin.BackButton.SceneQuestBookX;
  };

  Scene_QuestBook.prototype.backButtonY = function() {
    return TMPlugin.BackButton.SceneQuestBookY;
  };
  ...
  Scene_Party.prototype.backButtonX = function() {
    return TMPlugin.BackButton.ScenePartyX;
  };

  Scene_Party.prototype.backButtonY = function() {
    return TMPlugin.BackButton.ScenePartyY;
  };
