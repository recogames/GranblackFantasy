...
Window_ShopStatus.prototype.drawActorEquipInfo = function(x, y, actor) {
    ...
    //this.drawText(actor.name(), x, y - 20, 168);
	...
	for(var i = 0;i < 8;i++){
		...
		//this.drawParamName(x,112 + i*35,i);
		this.drawParamName(x,112 + temp_y,i);
	}
...
Window_ShopStatus.prototype.drawActorParamChange = function(x, y, actor, item1) {
	...
	for(var i = 0;i < 8;i++){
		...
		this.drawText( (changeParams[i] > 0 ? '+' : '') + changeParams[i], x, 60 + y + temp_y, width, 'right');
	}
};