...
TMPlugin.OmitEquipCommand.Parameters = PluginManager.parameters('TMOmitEquipCommand');
TMPlugin.OmitEquipCommand.UseOptimize = TMPlugin.OmitEquipCommand.Parameters['useOptimize'] === '1';
TMPlugin.OmitEquipCommand.UseClear    = TMPlugin.OmitEquipCommand.Parameters['useClear'] === '1';
...
(function() {
  ...
  Scene_Equip.prototype.update = function() {
    ...
    if (this._slotWindow.active) {
      ...
      } else if (Input.isTriggered('control') && TMPlugin.OmitEquipCommand.UseClear) {
        this.commandClear();
      }
    }
  };
